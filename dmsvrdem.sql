Rem
Rem $Header: dmsvrdem.sql 02-aug-2006.06:39:48 jiawang Exp $
Rem
Rem dmsvrdem.sql
Rem
...
SELECT setting_name, setting_value
  FROM TABLE(DBMS_DATA_MINING.GET_MODEL_SETTINGS('SVMR_SH_Regr_sample'))
...
SELECT attribute_name, attribute_type
  FROM TABLE(DBMS_DATA_MINING.GET_MODEL_SIGNATURE('SVMR_SH_Regr_sample'))
