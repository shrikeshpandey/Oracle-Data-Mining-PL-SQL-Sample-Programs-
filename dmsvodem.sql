Rem
Rem $Header: dmsvodem.sql 19-jan-2005.18:37:46 jcjeon Exp $
Rem
Rem dmsvodem.sql
Rem
...
BEGIN
  DBMS_DATA_MINING.DROP_MODEL('SVMO_SH_Clas_sample');
EXCEPTION WHEN OTHERS THEN
  NULL;
END;
/
...
SELECT setting_name, setting_value
  FROM TABLE(DBMS_DATA_MINING.GET_MODEL_SETTINGS('SVMO_SH_Clas_sample'))
