Rem
Rem $Header: dmnmdemo.sql 22-feb-2007.10:54:20 xbarr Exp $
Rem
Rem dmnmdemo.sql
Rem
...
-- BEGIN       
  ...
  -- INSERT INTO kmns_settings (setting_name, setting_value) VALUES
...
SELECT setting_name, setting_value
  FROM TABLE(DBMS_DATA_MINING.GET_MODEL_SETTINGS('NMF_SH_sample'))
...
SELECT attribute_name, attribute_type
  FROM TABLE(DBMS_DATA_MINING.GET_MODEL_SIGNATURE('NMF_SH_sample'))
