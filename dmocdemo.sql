Rem $Header: dmocdemo.sql 11-jul-2005.14:13:43 ktaylor Exp $
Rem
Rem dmocdemo.sql
Rem
...
SELECT setting_name, setting_value
  FROM TABLE(DBMS_DATA_MINING.GET_MODEL_SETTINGS('OC_SH_Clus_sample'))
...
SELECT attribute_name, attribute_type
  FROM TABLE(DBMS_DATA_MINING.GET_MODEL_SIGNATURE('OC_SH_Clus_sample'))
