Rem
Rem $Header: dmnbdemo.sql 11-jul-2005.13:22:45 ktaylor Exp $
Rem
Rem dmnbdemo.sql
Rem
...
SELECT setting_name, setting_value
  FROM TABLE(DBMS_DATA_MINING.GET_MODEL_SETTINGS('NB_SH_Clas_sample'))
...
SELECT attribute_name, attribute_type
  FROM TABLE(DBMS_DATA_MINING.GET_MODEL_SIGNATURE('NB_SH_Clas_sample'))
