Rem
Rem $Header: dmtxtnmf.sql 14-jul-2005.12:16:44 ktaylor Exp $
Rem
Rem nmfdemo.sql
Rem
...
SELECT *
  FROM TABLE(dbms_data_mining.get_model_settings('T_NMF_Sample'))
...
SELECT *
  FROM TABLE(dbms_data_mining.get_model_signature('T_NMF_Sample'))
