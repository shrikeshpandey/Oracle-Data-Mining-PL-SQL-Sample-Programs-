Rem
Rem $Header: dmkmdemo.sql 02-aug-2006.09:48:54 jiawang Exp $
Rem
Rem dmkmdemo.sql
Rem
...
SELECT setting_name, setting_value
  FROM TABLE(DBMS_DATA_MINING.GET_MODEL_SETTINGS('KM_SH_Clus_sample'))
...
SELECT attribute_name, attribute_type
  FROM TABLE(DBMS_DATA_MINING.GET_MODEL_SIGNATURE('KM_SH_Clus_sample'))
ORDER BY attribute_name;

-------------------------
-- DISPLAY MODEL METADATA
--
column function_name format a20
column algorithm_name format a20
SELECT function_name, algorithm_name, model_size
  FROM DM_USER_MODELS
 WHERE name = 'KM_SH_CLUS_SAMPLE';
